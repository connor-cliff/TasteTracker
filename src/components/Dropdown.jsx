...
const options = ['Any cuisine', 'American', 'Brazilian', 'Caribbean', 'Chinese', 'French', 'Greek', 'Indian', 'Italian', 'Japanese', 'Korean', 'Mediterranean', 'Mexican', 'Middle Eastern', 'Peruvian', 'Spanish', 'Thai', 'Vietnamese'];

/* Split button group taken from MUI components library - https://mui.com/material-ui/react-button-group/ */
